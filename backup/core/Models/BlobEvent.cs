...
/**
 * Description:
 * This class represents the object model of an 'Blob Event' triggered by Azure EventGrid when Storage Blobs are
 * manipulated.  The Blob Event is delivered to an Azure Storage Queue.
 * 
 * Author: GR @Microsoft
 * Dated: 05-23-2020
 *
